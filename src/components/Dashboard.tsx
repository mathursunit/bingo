        ...
        <div>
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        ...
                        <p className={cn(
                            ...
                            )}>{user?.displayName?.split(' ')[0] || 'Bingo Player'}</span>
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className={cn(
                            "flex items-center gap-2 px-4 py-2 font-bold rounded-lg transition-colors shadow-lg active:scale-95",
                            isLightTheme
                                ? "bg-slate-900 text-white hover:bg-slate-800"
                                : "bg-white text-bg-dark hover:bg-slate-200"
                        )}
                    >
                    ...
                    {boards.filter(b => b.myRole === 'owner').map(board => {
                        ...
                        return (
                            <div
                                ...
                                className={cn(
                                    "group relative h-48 p-6 flex flex-col justify-between cursor-pointer overflow-hidden active:scale-[0.99] rounded-xl border transition-all",
                                    isLightTheme
                                        ? "bg-white border-slate-200 hover:bg-slate-50 hover:shadow-lg"
                                        : "bg-[var(--theme-bg-card)] border-[var(--theme-border)] hover:bg-zinc-900"
                                )}
                            >
                                ...
                                <div className="absolute top-4 right-4 flex gap-2 z-20">
                                    <button
                                        ...
                                        className={cn(
                                            "p-2 rounded-full transition-all opacity-100 md:opacity-0 md:group-hover:opacity-100",
                                            isLightTheme
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                        ...
                                        {editingBoardId === board.id ? (
                                            <div className="flex items-center gap-2 mb-1.5 z-30 relative" onClick={e => e.stopPropagation()}>
                                                <input
                                                    ...
                                                    autoFocus
                                                    className={cn(
                                                        "font-bold text-xl rounded px-2 py-0.5 border border-accent-primary outline-none min-w-0 flex-1 w-full",
                                                        isLightTheme
                                            ...
                                            <div className="flex items-start gap-2 pr-8 mb-1.5">
                                                <h3 className={cn(
                                                    "text-xl font-bold line-clamp-2 group-hover:text-accent-primary transition-colors",
                                                    isLightTheme ? "text-slate-800" : "text-white"
                                                )}>
                                                    {board.title}
                                                </h3>
                                                <button
                                                    ...
                                                    className={cn(
                                                        "opacity-0 group-hover:opacity-100 p-1.5 rounded-full transition-all z-20",
                                                        isLightTheme
                                    ...
                                    <div className="mt-4">
                                        <span className={cn(
                                            "inline-block px-4 py-1.5 rounded-xl text-xs font-bold border transition-all shadow-sm",
                                            isLightTheme
                                                ? "bg-accent-primary/10 text-accent-primary border-accent-primary/20 group-hover:bg-accent-primary group-hover:text-white"
                                                : "bg-accent-primary/10 text-accent-primary border-accent-primary/20 group-hover:bg-accent-primary group-hover:text-white"
                                        )}>
                                            Open Board
                                        </span>
                ...
                {boards.filter(b => b.myRole !== 'owner').length > 0 && (
                    <>
                        <h2 className={cn(
                            "text-xl font-bold mt-10 mb-6 flex items-center gap-2",
                            isLightTheme ? "text-slate-800" : "text-white"
                        )}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {boards.filter(b => b.myRole !== 'owner').map(board => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={cn(
                                            "absolute top-0 right-0 p-4 transition-opacity pointer-events-none",
                                            isLightTheme ? "opacity-5 group-hover:opacity-10" : "opacity-10 group-hover:opacity-20"
                                        )}>
                                        ...
                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="flex-1">
                                                ...
                                                <h3 className={cn(
                                                    "text-xl font-bold mb-1 line-clamp-1 pr-8",
                                                    isLightTheme ? "text-slate-800" : "text-white"
                                                )}>
                                                    {board.title}
                                                </h3>
                                                {board.ownerName && (
                                                    <div className={cn(
                                                        ...
                                                        Shared by <span className={isLightTheme ? "text-slate-700" : "text-slate-400"}>{board.ownerName}</span>
                                                    </div>
                                                )}
                                                <div className={cn(
                                                    "flex items-center gap-2 text-xs",
