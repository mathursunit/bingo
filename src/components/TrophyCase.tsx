...
export const TrophyCase: React.FC = () => {
    ...
    // Calculate total unlocked for summary
    const totalUnlocked = BADGES.filter(b => (userProgress[b.id]?.progress || 0) >= b.maxProgress).length;

    return (
        <div className={cn(
            "rounded-3xl border shadow-xl overflow-hidden mb-8",
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className={cn("text-xl md:text-2xl font-bold", isLightTheme ? "text-slate-900" : "text-white")}>Trophy Case</h2>
                ...
                <div className={cn(
                    ...
                    isLightTheme ? "text-slate-400 group-hover:bg-slate-100" : "text-slate-500 group-hover:bg-white/5"
                )}>
            ...
            <AnimatePresence>
                {isExpanded && (
                    ...
                    >
                        <div className="p-6 md:p-8 pt-0 border-t border-dashed border-slate-200 dark:border-white/10">
                            {loading ? (
